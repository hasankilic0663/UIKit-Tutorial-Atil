...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        kenny1.isUserInteractionEnabled = true//tıklanabilir hale getirdik
...
//        var sda = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(countDown), userInfo: nil, repeats: true )
    ...
    @objc func hideKenny() {
        ...
        let random = Int(arc4random_uniform(UInt32(kennyArray.count-1) )) //rastegele dedigin sayıya kadar sayı üretiyo
    ...
    @objc func countDown() {
        ...
        if counter == 0 {
            timer.invalidate()//timerı durdurma metodu
